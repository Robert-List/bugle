...
package_sources.extend([
    ...
    'doc/DocBook/manpages/contextattribs.xml',
    ...
    'doc/DocBook/manpages/logdebug.xml',
    ...
    'src/bc/gl/GL_ARB_sync.bc',
    'src/bc/gl/GL_ARB_texture_compression.bc',
    'src/bc/gl/GL_ARB_transform_feedback2.bc',
    ...
    'src/bc/gl/GL_EXT_transform_feedback.bc',
    ...
    'src/platform/process_linux.c',
    'src/platform/process_null.c',
    ...
    'src/tests/bugletest.py',
    'src/tests/contextattribs.c',
    'src/tests/dlopen.c',
    'src/tests/draw.c',
    'src/tests/errors.c',
    ...
    'src/tests/logdebug.c',
    'src/tests/math.c',
    'src/tests/objects.c',
    'src/tests/options.txt.in',
    'src/tests/pbo.c',
